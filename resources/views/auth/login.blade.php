...
@section('title', 'Sign In - StartupHub')
...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md animate-slideUp">
        ...
        <!-- Login Form -->
        <form method="POST" action="/login" class="space-y-6 bg-white rounded-2xl shadow-premium border border-slate-200 p-8">
            @csrf
            ...
            <div class="flex items-center">
                <input 
                    ...
                    name="remember" 
                    id="remember"
                    class="w-4 h-4 text-primary-600 bg-slate-50 border-slate-300 rounded focus:ring-2 focus:ring-primary-500"
                >
            ...
            <button 
                type="submit"
                class="w-full px-6 py-3 bg-gradient-primary text-white rounded-lg font-semibold hover-glow transition-all"
            >
                Sign In
            </button>
        </form>
        ...
        <div class="mt-8 relative">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-slate-50 text-slate-600">Or continue with</span>
            </div>
        </div>
